...
| 01    | [phase-01-connection-mvp.md](./phase-01-connection-mvp.md)                                         | P0     | 已具备 P0 测试覆盖                       | `test:sql-services` 69/69 + `test:sql-connections` 117/117 绿                                                                    | saved profile 不落 secret；Postgres UI 被禁                                                    |
| 02    | [phase-02-metadata-explorer.md](./phase-02-metadata-explorer.md)                                   | P0     | 已具备 P0 测试覆盖                       | `test:sql-connections` 117/117 绿                                                                                                | 三级 tree + per-node error / refresh                                                           |
