...
| 01    | [phase-01-connection-mvp.md](./phase-01-connection-mvp.md)                                         | P0     | 已具备 P0 测试覆盖                       | `test:sql-services` 69/69 + `test:sql-connections` 112/112 绿                                                                    | saved profile 不落 secret；Postgres UI 被禁                                                    |
| 02    | [phase-02-metadata-explorer.md](./phase-02-metadata-explorer.md)                                   | P0     | 已具备 P0 测试覆盖                       | `test:sql-connections` 112/112 绿                                                                                                | 三级 tree + per-node error / refresh                                                           |
| 03    | [phase-03-editor-execution.md](./phase-03-editor-execution.md)                                     | P0     | 已具备 P0 测试覆盖                       | `test:sql-editor` 60/60 绿                                                                                                       | all / selected / current 三种执行 + Ctrl+Enter                                                 |
| 04    | [phase-04-result-panel.md](./phase-04-result-panel.md)                                             | P0     | 已具备 P0 测试覆盖                       | `test:sql-result` 58/58 绿                                                                                                       | columns/rows/affected/elapsed/error 四态                                                       |
...
| 08    | [phase-08-mvp-packaging.md](./phase-08-mvp-packaging.md)                                           | P0     | 已完成 P0 验收                           | `pnpm run test` 绿；`pnpm run test:mysql-integration` 1/1 绿；原生 Demo 走查绿                  | demo.db、Welcome、validation、release gate、原生 Demo 与 live MySQL 记录均已验                  |
