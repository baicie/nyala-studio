	...
	registry.registerConfiguration({
		...
		properties: {
			...
			'workbench.editor.showTabIndex': {
				...
				default: false,
				markdownDescription: localize(
					{ comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'showTabIndex' },
			...
			[LayoutSettings.ACTIVITY_BAR_AUTO_HIDE]: {
				...
				default: false,
				markdownDescription: localize(
					{ comment: ['This is the description for a setting'], key: 'activityBarAutoHide' },
			...
			[LayoutSettings.ACTIVITY_BAR_COMPACT]: {
				...
				default: false,
				markdownDescription: localize(
					{ comment: ['This is the description for a setting'], key: 'activityBarCompact' },
			...
			'workbench.activityBar.iconClickBehavior': {
				...
				default: 'toggle',
				markdownDescription: localize(
					{ comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'activityBarIconClickBehavior' },
			...
			'workbench.navigationControl.enabled': {
				...
				markdownDescription: isWeb
					...
					: localize(
							{ key: 'navigationControlEnabled', comment: ['{0}, {1} is a placeholder for a setting identifier.'] },
